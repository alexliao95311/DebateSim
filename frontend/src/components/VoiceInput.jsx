    ...
    recognition.onresult = (event) => {
      ...
      if (newFinalTranscript) {
        setFinalTranscript(prevFinal => {
          ...
          // Also update the display transcript
        ...
        setFinalTranscript(currentFinal => {
          ...
          return currentFinal; // Don't change final transcript
        });
      }
    };
